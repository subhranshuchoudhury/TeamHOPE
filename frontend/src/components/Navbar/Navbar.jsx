      ...
      <div className="fixed right-[40%]">
        ...
        >
          <div className="flex items-center gap-4">
            ...
            />
            <div className="fixed right-[90%] text-xl text-Teal uppercase tracking-wide font-bold">
              Skillex
            </div>
          </div>
         ...
         <button
            className='fixed right-[5%] py-3 px-6 font-bold text-sm border border-solid rounded-lg border-gray'
            onClick={() => {
